...
(async () => {
  ...
  await p.goto('http://localhost:8099/mobile/assets-src/iconart.html'); await p.evaluate(async () => { await document.fonts.load('bold 120px "Pixelify Sans"', 'BALIKÇI TYCOON'); await document.fonts.ready; }); await new Promise(r => setTimeout(r, 400));
