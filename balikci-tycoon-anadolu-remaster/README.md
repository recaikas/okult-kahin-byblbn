# Balıkçı Tycoon — Anadolu Limanı Remaster

Bu klasör, özgün `balikci-tycoon/` sürümünü bozmadan hazırlanan bağımsız görsel remaster kopyasıdır.

## Görsel kimlik

- Ege ve Marmara kıyı kasabalarından esinlenen lacivert, çini turkuazı, kiremit kırmızısı, pirinç ve kırık beyaz palet
- Kasket, balıkçı yeleği, kuşak, yazma, önlük ve kaptan başlığıyla ayrışan oyuncu/çalışan/müşteri sprite'ları
- Dört kare yönlü yürüyüş hissi, nefes alma, kol-bacak salınımı, iş, sabırsızlık, öfke ve memnuniyet tepkileri
- Nazar, çini şerit, Türk bayrağı, taka, begonvil, zeytinlik tepe ve kıyı pazarı detayları
- Beş seviye hizmet binasında ahşap kulübeden taş/tuğla tesise ve bayraklı ticari komplekse görsel evrim
- Mobilde okunabilen yeniden tasarlanmış HUD, alt kategori şeridi, kartlar, menüler ve geri bildirimler

## Korunan sistemler

Ana balıkçılık döngüsü, kayıt yapısı, şirketler, kontratlar, holding, hizmet binaları ve eski kayıt uyumluluğu korunur. Remaster kendi klasöründe çalışır ve özgün klasördeki dosyalara dokunmaz.
